...
func RequireScope(ss ScopeStrategy, result *OAuth2IntrospectionResult, scopes []string) bool {
...
func RequireHierarchicScope(result *OAuth2IntrospectionResult, scopes ...string) bool {
	return RequireScope(HierarchicScopeStrategy, result, scopes)
}

func RequireExactScope(result *OAuth2IntrospectionResult, scopes ...string) bool {
	return RequireScope(ExactScopeStrategy, result, scopes)
}

func RequireWildcardScope(result *OAuth2IntrospectionResult, scopes ...string) bool {
	return RequireScope(WildcardScopeStrategy, result, scopes)
}
...
func ExactScopeStrategy(haystack []string, needle string) bool {
	return containsSring(haystack, needle)
}
